...
The following fourteen active derived files are present. The three pixel-buffer
foundation files remain bound to the initial foundation commit. Files changed
by the screenshot-first archive migration were reverified against
`fcac032343c6cf2482d6f4551c65726843a4e4ff`. A worktree marker is used only
while preparing a derived-file change and must be replaced by the resulting
...
| `src/WinDayFlow.Capture.Native/internal/capture_policy.h` | `windows/runner/capture_runtime.h` | `134EEC71A54F0AE13EFC24045A97360221401FB5611E950BE1C92476B036752D` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Added frame-only cadence reanchoring so each chunk's first successfully encoded frame establishes the next sample without changing the independent context cadence. |
| `src/WinDayFlow.Capture.Native/internal/capture_policy.cpp` | `windows/runner/capture_runtime.cpp` | `0285D25EB24D9D81495226DD2DC0FF055ECA9A1E336BBE5AF5FA507DB8E0B132` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Added overflow-safe frame-only deadline reanchoring while preserving the independent context schedule and existing no-burst behavior. |
...
| `src/WinDayFlow.Capture.Native/tests/capture_policy_tests.cpp` | `windows/runner/capture_runtime_test.cpp` | `F013F0005A5E07D32BF02B41FDFDCA652003AAAC64E3B73EC49B3988CB23610A` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Added monotonic context-cadence preservation and `INT64_MAX` exhaustion coverage for per-chunk frame reanchoring. |
| `src/WinDayFlow.Capture.Native/internal/atomic_chunk_store.h` | `windows/runner/capture_service.cpp` | `C6E1B51B8CB9B28A82BAA085E69D1597CC9BEDA64354DEA1CB2824F197D8F9A3` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Replaced the encoded-video input with a bounded JPEG-frame writer while retaining transactional prepare, commit, acknowledgement, and rollback ownership. |
| `src/WinDayFlow.Capture.Native/internal/atomic_chunk_store.cpp` | `windows/runner/capture_service.cpp` | `25155FFFF0B3E47BEF2D07186D4611189B46D4D0F735B0D2B34BB1308136A955` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Streams bounded JPEG frames into no-follow same-volume staging, flushes each artifact, prepares the manifest last, commits without overwrite, and preserves retryable rollback. |
| `src/WinDayFlow.Capture.Native/internal/chunk_manifest.h` | `windows/runner/capture_service.cpp` | `A543E9C59A7EBD41C7E168CA97C9D598B1F4619765FAD62CDE66DA8FC96A884D` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Defines schema 4 JPEG frames, black and duplicate counters, capture scope, and bounded application and context telemetry without titles or executable paths. |
| `src/WinDayFlow.Capture.Native/internal/chunk_manifest.cpp` | `windows/runner/capture_service.cpp` | `DCD858403E5B38940BB4606FD4BEB56FEC19580C20CA800F3F40247998DAB001` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Validates zero-retained-frame chunks, frame hashes and byte totals, ordered context samples, and bounded process telemetry before serializing privacy-safe schema 4 JSON. |
| `src/WinDayFlow.Capture.Native/internal/dxgi_desktop_frame_source.h` | `windows/runner/capture_service.cpp` | `96DFE4CC5CB7D9AC849015D007B3B50841927E3405C1E9F8F6BD50A14A9CA89C` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Split the display-bound Desktop Duplication source from lifecycle and persistence concerns, with explicit 8K/BGRA bounds, a distinct access-denied result for controlled WGC fallback, and fail-closed outcomes. |
| `src/WinDayFlow.Capture.Native/internal/dxgi_desktop_frame_source.cpp` | `windows/runner/capture_service.cpp` | `1C6F70182B11FC040C7E16A6151AF7BF3A650435E85EA8E08A47CE31A081BCEB` | `fcac032343c6cf2482d6f4551c65726843a4e4ff` | Uses only the strict resolver, revalidates the full fingerprint, bounds GPU/CPU geometry, distinguishes access denial from transient device loss, orders Unmap/ReleaseFrame cleanup, never reuses timeout pixels, and safely copies pitched/rotated BGRA data. |
| `src/WinDayFlow.Capture.Native/internal/wic_bgra_scaler.h` | `windows/runner/capture_service.cpp` | `2AE028EB5AE7E1B1BBBB3338716657D84693D9AC40A63E946C7B17F9125BA874` | `b18a5df60e9af4b464c291043f2609a308ea2360` | Isolated bounded BGRA scaling and even archive-frame dimension calculation behind an internal WIC contract. |
