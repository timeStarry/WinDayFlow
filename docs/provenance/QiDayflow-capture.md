...
| `src/WinDayFlow.Capture.Native/tests/capture_policy_tests.cpp` | `windows/runner/capture_runtime_test.cpp` | `9E6461B6ABF628A9C81FB4789A6132510063BBC6AA062ED85E299CB1016A65FF` | `3d53b65552b6fc6f4a007afb3ebac277609162ed` | Adapted timing and scheduling assertions to versioned policy inputs and added generic fail-closed handling for unknown privacy inputs. |
...
| `src/WinDayFlow.Capture.Native/internal/chunk_manifest.h` | `windows/runner/capture_service.cpp` | `E2B0A7412309D88B1A9995794E0C935246C262BEDF9718507948E1E60228DFF8` | `b18a5df60e9af4b464c291043f2609a308ea2360` | Reduced chunk metadata to a closed, privacy-safe schema bound to persistence generation and target epoch. |
| `src/WinDayFlow.Capture.Native/internal/chunk_manifest.cpp` | `windows/runner/capture_service.cpp` | `3C3F60B7AF4EEFD425DF583018A0890C3C64DBBBD66B4869EA9C558967CC8AD4` | `b18a5df60e9af4b464c291043f2609a308ea2360` | Removed raw titles, process names, paths, handles, and display identifiers; emits only validated timing, video, and authorization fields. |
| `src/WinDayFlow.Capture.Native/internal/dxgi_desktop_frame_source.h` | `windows/runner/capture_service.cpp` | `4FB1176088AF85D57804428CCC13BE277B73F702993767EF52DA1BADFB9FEDAB` | `b18a5df60e9af4b464c291043f2609a308ea2360` | Split the display-bound Desktop Duplication source from lifecycle and persistence concerns, with explicit 8K/BGRA bounds and fail-closed outcomes. |
| `src/WinDayFlow.Capture.Native/internal/dxgi_desktop_frame_source.cpp` | `windows/runner/capture_service.cpp` | `3F3ED39083483E2CA6137D56ECCBAA760037C53577FAEC1BEAE83A48593987E1` | `b18a5df60e9af4b464c291043f2609a308ea2360` | Uses only the strict resolver, revalidates the full fingerprint, bounds GPU/CPU geometry, maps device loss, orders Unmap/ReleaseFrame cleanup, never reuses timeout pixels, and safely copies pitched/rotated BGRA data. |
