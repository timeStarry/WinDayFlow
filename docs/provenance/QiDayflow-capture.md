...
| `src/WinDayFlow.Capture.Native/internal/atomic_chunk_store.h` | `windows/runner/capture_service.cpp` | `2EFB508275D7F183B774F310DB9CB5601D2033181689E8A8835E7F111715CD9E` | `WORKTREE (pending commit)` | Replaced per-file publication with a typed-manifest, bounded whole-directory transaction and an acknowledgement-controlled, retryable compensation handle. |
| `src/WinDayFlow.Capture.Native/internal/atomic_chunk_store.cpp` | `windows/runner/capture_service.cpp` | `9F9F0EBCD34E8769396152A57E9AE275FC31D0929F4C52F2D050348EE35437CB` | `WORKTREE (pending commit)` | Added no-follow identity locks for the local directory chain, same-volume staging, exact flushes, handle-bound no-overwrite rename, and observable retryable rollback before event acknowledgement. |
| `src/WinDayFlow.Capture.Native/internal/chunk_manifest.h` | `windows/runner/capture_service.cpp` | `E2B0A7412309D88B1A9995794E0C935246C262BEDF9718507948E1E60228DFF8` | `WORKTREE (pending commit)` | Reduced chunk metadata to a closed, privacy-safe schema bound to persistence generation and target epoch. |
| `src/WinDayFlow.Capture.Native/internal/chunk_manifest.cpp` | `windows/runner/capture_service.cpp` | `3C3F60B7AF4EEFD425DF583018A0890C3C64DBBBD66B4869EA9C558967CC8AD4` | `WORKTREE (pending commit)` | Removed raw titles, process names, paths, handles, and display identifiers; emits only validated timing, video, and authorization fields. |
| `src/WinDayFlow.Capture.Native/internal/dxgi_desktop_frame_source.h` | `windows/runner/capture_service.cpp` | `4FB1176088AF85D57804428CCC13BE277B73F702993767EF52DA1BADFB9FEDAB` | `WORKTREE (pending commit)` | Split the display-bound Desktop Duplication source from lifecycle and persistence concerns, with explicit 8K/BGRA bounds and fail-closed outcomes. |
| `src/WinDayFlow.Capture.Native/internal/dxgi_desktop_frame_source.cpp` | `windows/runner/capture_service.cpp` | `3F3ED39083483E2CA6137D56ECCBAA760037C53577FAEC1BEAE83A48593987E1` | `WORKTREE (pending commit)` | Uses only the strict resolver, revalidates the full fingerprint, bounds GPU/CPU geometry, maps device loss, orders Unmap/ReleaseFrame cleanup, never reuses timeout pixels, and safely copies pitched/rotated BGRA data. |
| `src/WinDayFlow.Capture.Native/internal/mf_h264_chunk_writer.h` | `windows/runner/capture_service.cpp` | `E93746B6A4F1824FAADBF0DB75F8BA8B3D633CA5613E9289D0FEFEB89329E913` | `WORKTREE (pending commit)` | Replaced path-backed sink ownership with an explicit same-thread, bounded, in-memory H.264 writer state machine. |
| `src/WinDayFlow.Capture.Native/internal/mf_h264_chunk_writer.cpp` | `windows/runner/capture_service.cpp` | `657F58428EF22BDBF718C9FE103D5A9AFBB74E836B9E6B8AE61AA897A3953529` | `WORKTREE (pending commit)` | Added a 64 MiB fail-closed COM stream, paired COM/MF lifetime, strict BGRA samples, final-frame timing, secure overflow discard, and no temporary video file. |
| `src/WinDayFlow.Capture.Native/internal/wic_bgra_scaler.h` | `windows/runner/capture_service.cpp` | `2AE028EB5AE7E1B1BBBB3338716657D84693D9AC40A63E946C7B17F9125BA874` | `WORKTREE (pending commit)` | Isolated bounded BGRA scaling and even H.264 dimension calculation behind an internal WIC contract. |
| `src/WinDayFlow.Capture.Native/internal/wic_bgra_scaler.cpp` | `windows/runner/capture_service.cpp` | `9849E326507839C87AE30A4D707CA7CEE5EF7E40A2F90E08D402CDA3FC33570C` | `WORKTREE (pending commit)` | Prevents upscaling, validates exact byte geometry and UINT bounds, preserves aspect ratio, and normalizes output alpha. |
